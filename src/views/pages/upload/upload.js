          ...
          <CCard>
            ...
            <CCardBody>
              <CForm className="form-horizontal">
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="photo-title">Book Name</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CInput  placeholder="Book Name" />
                  ...
                  <CCol xs="12" md="9">
                    <CInputGroup className="input-prepend">
                      <CInputGroupPrepend>
                        ...
                        <CInput id="photo-price" name="photo-price" type="number" />
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="photo-status">Writer's Name</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CInput  placeholder="Writer's Name" />
                    <CFormText>Set name for your book's writer</CFormText>
                ...
                <CFormGroup row>
                  <CCol md="3">
                    <CLabel htmlFor="photo-title">Book introduction</CLabel>
                  </CCol>
                  <CCol xs="12" md="9">
                    <CInput  placeholder="Book imformation" />
                    {/* <CInput id="photo-title" name="photo-title" placeholder="Photo Title" value={title} onChange={e => titleChange(e)}/> */}
                    <CFormText>Enter a introduction for your book</CFormText>
                  </CCol>
                </CFormGroup>
              ...
              >
                ...
                <CModalFooter>
                  <CButton color="warning" >Try again</CButton>
