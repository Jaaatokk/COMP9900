...
import {
  ...
  CButton,
  CCardBody,
  CContainer, CFooter, CModal, CModalHeader, CModalTitle, CCol, CCard, CRow, CDataTable,CFormGroup,CFormText
} from '@coreui/react'
    ...
    const  checkcontent = this.state.checklist.map((item,no)=>
        <CFormGroup key={no}>
          <div>
            ...
            <CFormText> {item['name']}   &nbsp;  &nbsp;  &nbsp;  &nbsp;      $ {item['price']} </CFormText>
      ...
      return(
          ...
          <CCol xs="12" md="10">
            <CCard>
              ...
              <CCardBody>
                <CRow>
                  <CCol>
                    You select {this.state.checklist.length} Books!
                    <CCardBody>
                      {checkcontent}
              ...
              <CFooter>
                <Link to='/readypay'><CButton class='success' type='button' onClick={this.sendCheck}> Create Order</CButton></Link>
        ...
        {/*<CModal*/}
        {/*  show={this.state.success_clear}*/}
        {/*  onClose={() => !this.state.success_clear}*/}
        {/*  color="info"*/}
        {/*>*/}
        {/*  <CModalHeader closeButton>*/}
        {/*    <CModalTitle>Clear Successful</CModalTitle>*/}
        {/*  </CModalHeader>*/}
        {/*  /!*<CModalBody>*!/*/}
        ...
        {/*  <CButton color="success" onClick={() => this.setState({success_clear:!this.state.success_clear})}>Done</CButton>*/}
        {/*  /!*</CModalFooter>*!/*/}
        {/*</CModal>*/}
